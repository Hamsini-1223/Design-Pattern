Singleton Pattern: Ensure a single instance of certain classes and provide a global point of access to it.
...
**Usage**
- javac -source 1.8 -target 1.8 -d bin singleton/*.java
- java -cp bin singleton.SingletonPatternMain 
